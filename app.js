...
const defaultOpportunities = [
  {
    id: "grounz-5805",
    title: "제4회 경산 Again 대학가요제",
    host: "영남일보 (경산시·대구대학교 후원)",
    applicationOpen: "2026-05-21",
    deadline: "2026-07-31",
    status: "open",
    fitLabel: "확인 필요",
    fitScore: 3,
    ...
    preparation: "미발표 창작곡 음원·실연 영상, 대학 재학/휴학 증빙, 공식 홈페이지 참가신청서",
    officialUrl: "https://gsacsf-mo.imweb.me/index",
    sourceNote: "GROUNZ 자동수집 후 공식(imweb) 확인 · 접수 5/21~7/31, 본선 9/16 대구대",
    lastCheckedAt: "2026-07-18T09:00:00+09:00",
    sortOrder: 10,
  },
  {
    id: "grounz-5809",
    title: "2026 전일가요제 (VOC MUSIC FESTIVAL)",
    host: "글로벌광주방송(GGN)",
    ...
    preparation: "자작곡 1곡(AI 생성 불가) + 자유곡 1곡, 남은 8·9월 회차 접수",
    officialUrl: "https://www.ggn.or.kr/bbs/view.do?bcId=comm_notice&baId=100972&menuNo=99",
    sourceNote: "GROUNZ 자동수집 후 공식(GGN) 확인 · 월별 회차, 최종 마감 9/6",
    lastCheckedAt: "2026-07-18T09:00:00+09:00",
    sortOrder: 20,
  },
  {
    ...
    preparation: "대표곡 MP3(또는 영상 URL)와 아티스트 소개를 다음 회차 공고 시 바로 접수할 수 있게 정리",
    officialUrl: "https://www.ebs.co.kr/space/rookie/audition",
    sourceNote: "EBS 스페이스 공감 공식 헬로루키 페이지 기준, 2027 재개 모니터링",
    lastCheckedAt: "2026-07-18T09:00:00+09:00",
    sortOrder: 30,
  },
  {
    ...
    preparation: "제38회 공고(2027년 4~5월경) 전에 본인 작사·작곡·편곡·연주 자작곡 음원과 실연 영상 정리",
    officialUrl: "https://yjh.or.kr/application",
    sourceNote: "유재하음악장학회 공식 기준 · 제37회 접수 종료, 제38회 2027 예상",
    lastCheckedAt: "2026-07-18T09:00:00+09:00",
    sortOrder: 40,
  },
  {
    id: "hiddenstage-2026",
    title: "2026 히든스테이지 (제4회)",
    host: "뉴스핌 · 감엔터테인먼트",
    ...
    preparation: "제5회 공고(2027년 2~3월경) 전에 미발표 창작곡 음원(mp3)·실연 영상·가사지·프로필 갱신",
    officialUrl: "https://hiddenstage.co.kr/",
    sourceNote: "공식 사이트 기준 · 제4회 접수 종료·본선 진행, 제5회 2027 예상",
    lastCheckedAt: "2026-07-18T09:00:00+09:00",
    sortOrder: 50,
  },
];
